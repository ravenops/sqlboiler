...
func TestMergeSet(t *testing.T) {
	...
	a := Set{
		Standard:   List{"fmt"},
		ThirdParty: List{"github.com/ravenops/sqlboiler", "github.com/volatiletech/null"},
	}
	b := Set{
		Standard:   List{"os"},
	...
	if c.ThirdParty[0] != "github.com/volatiletech/null" && c.ThirdParty[1] != "github.com/ravenops/sqlboiler" {
		t.Errorf("Wanted: github.com/ravenops/sqlboiler, github.com/volatiletech/null got: %#v", c.ThirdParty)
	}
}
